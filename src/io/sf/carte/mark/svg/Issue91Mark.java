...
public class Issue91Mark {

	private final static String svgImage = Util.loadFilefromClasspath("svg/issue91.svg");

	private final static String imageURI = Issue91Mark.class.getResource("issue91.svg").toExternalForm();

	@Benchmark
	public void markIssue91() throws TranscoderException, IOException {
