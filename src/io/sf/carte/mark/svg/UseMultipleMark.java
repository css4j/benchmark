...
public class UseMultipleMark {

	private final static String svgImage = Util.loadFilefromClasspath("svg/useMultiple.svg");

	private final static String imageURI = UseMultipleMark.class.getResource("useMultiple.svg").toExternalForm();

	@Benchmark
	public void markUseMultiple() throws TranscoderException, IOException {
		...
		assert (ostream.size() > 1000);
	}

	@Benchmark
	public void markUseMultiple_Batik()
