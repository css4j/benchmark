...
public class DOMIteratorSmallMark {
	...
	@Benchmark
	public void markNodeIteratorJdk(DOMDataSmall data) {
		int count = 0;
	...
	@Benchmark
	public void markNodeIteratorDOM(DOMDataSmall data) {
		int count = 0;
	...
	@Benchmark
	public void markTreeWalkerJdk(DOMDataSmall data) {
		int count = 0;
		Node root = data.jdkDoc.getDocumentElement();
		if (root == null) {
			throw new IllegalStateException("Document has no element child.");
	...
	@Benchmark
	public void markTreeWalkerDOM(DOMDataSmall data) {
		int count = 0;
		Node root = data.domDoc.getDocumentElement();
	...
	@Benchmark
	public void markIteratorDOM(DOMDataSmall data) {
		int count = 0;
	...
	@Benchmark
	public void markElementIteratorDOM(DOMDataSmall data) {
		int count = 0;
	...
	@Benchmark
	public void markIteratorDOM4J(DOMDataSmall data) {
		int count = 0;
	...
	@Benchmark
	public void markElementIteratorDOM4J(DOMDataSmall data) {
		int count = 0;
		XHTMLDocument doc = (XHTMLDocument) data.dom4jDoc;
	...
	public void markIteratorJsoup(DOMDataSmall data) {
		...
		if (count < data.minimumCount) {
			throw new IllegalStateException("Expected a count of at least " + data.minimumCount + " obtained " + count);
		}
	}
